                      ...
                      <v-card>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          ...
                          <v-list-item>
                            ...
                            <v-list-item-content class="align-end">{{ item.purchase_date }} on {{ item.purchase_date }}</v-list-item-content>
                          </v-list-item>
                          <v-list-item>
                            <v-list-item-content>Recent value:</v-list-item-content>
                            <v-list-item-content class="align-end">{{ item.purchase_price }} on {{ item.purchase_price }}</v-list-item-content>
                          </v-list-item>
                        </v-list>
                      </v-card>
                    </v-col>
